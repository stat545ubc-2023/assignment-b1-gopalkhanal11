...
My function wouldn't have worked if I had specified that my grouping variable should be of character class because here the class of species in penguins dataset is `factor`
```{r}
...
For example, some of the values in penguins dataset has NAs. The function will handle the NA's and won't through error
